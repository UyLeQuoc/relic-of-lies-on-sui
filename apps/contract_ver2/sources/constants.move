/// Constants module for Love Letter 2019 Premium Edition (ZK Version)
...
/// Waiting for ZK proof response
const STATUS_PENDING_PROOF: u8 = 4;
public fun status_pending_proof(): u8 { STATUS_PENDING_PROOF }
...
// ============== ZK Proof Constants ==============
/// Timeout for ZK proof submission (60 seconds in milliseconds)
const PROOF_TIMEOUT_MS: u64 = 60_000;
public fun proof_timeout_ms(): u64 { PROOF_TIMEOUT_MS }

/// Commitment size in bytes (32 bytes for Poseidon hash)
const COMMITMENT_SIZE: u64 = 32;
public fun commitment_size(): u64 { COMMITMENT_SIZE }

// ============== Pending Action Types ==============
const ACTION_NONE: u8 = 0;
public fun action_none(): u8 { ACTION_NONE }

const ACTION_GUARD_PENDING: u8 = 1;
public fun action_guard_pending(): u8 { ACTION_GUARD_PENDING }

const ACTION_BARON_PENDING: u8 = 2;
public fun action_baron_pending(): u8 { ACTION_BARON_PENDING }

const ACTION_PRIEST_PENDING: u8 = 3;
public fun action_priest_pending(): u8 { ACTION_PRIEST_PENDING }

const ACTION_PRINCE_PENDING: u8 = 4;
public fun action_prince_pending(): u8 { ACTION_PRINCE_PENDING }

const ACTION_KING_PENDING: u8 = 5;
public fun action_king_pending(): u8 { ACTION_KING_PENDING }

const ACTION_CHANCELLOR_PENDING: u8 = 6;
public fun action_chancellor_pending(): u8 { ACTION_CHANCELLOR_PENDING }
