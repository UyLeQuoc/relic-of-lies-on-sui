...
/// Guard response pending - target must reveal card
const PENDING_GUARD_RESPONSE: u8 = 1;
public fun pending_guard_response(): u8 { PENDING_GUARD_RESPONSE }

/// Baron response pending - target must reveal card for comparison
const PENDING_BARON_RESPONSE: u8 = 2;
public fun pending_baron_response(): u8 { PENDING_BARON_RESPONSE }

/// Prince response pending - target must reveal discarded card
const PENDING_PRINCE_RESPONSE: u8 = 3;
public fun pending_prince_response(): u8 { PENDING_PRINCE_RESPONSE }

// ============== Seal/Decryptable Constants ==============
/// Required hash length for Decryptable
const HASH_LENGTH: u64 = 32;
public fun hash_length(): u64 { HASH_LENGTH }

/// Required nonce length for Decryptable
const NONCE_LENGTH: u64 = 32;
public fun nonce_length(): u64 { NONCE_LENGTH }
