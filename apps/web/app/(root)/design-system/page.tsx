...
import {
	...
	cardsMap,
	cardTypes,
} from "@/components/common/game-ui/cards/types";
import {
	Accordion,
	AccordionContent,
	AccordionItem,
		...
		<div className="container mx-auto py-8 px-4 max-w-7xl">
			<div className="mb-8">
				...
				<p className="text-muted-foreground">
					A comprehensive showcase of all UI components available in the design
					system.
				</p>
			</div>
			...
			<Tabs defaultValue="cards" className="w-full">
				...
				<TabsContent value="cards" className="space-y-6">
					...
					>
						<div className="flex flex-wrap gap-6 justify-center items-start">
							{cardTypes.map((cardType) => (
								...
								>
									<CardCharacter cardType={cardType} size="md" />
					...
					>
						<div className="flex flex-wrap gap-6 justify-center items-start">
							{[CardType.Value0, CardType.Value1, CardType.Value2].map(
								(cardType) => (
									<div
										key={cardType}
										className="flex flex-col items-center gap-2"
									>
										<CardCharacter cardType={cardType} size="md" flip />
										<p className="text-xs text-muted-foreground text-center">
											{
												cardsMap[CardConceptType.RelicOfLies].cards[cardType]
													.name
											}{" "}
											(Click to flip)
										</p>
				...
				<TabsContent value="forms" className="space-y-6">
					<ComponentShowcase title="Input" description="Text input component">
					...
					<ComponentShowcase title="Label" description="Form label component">
					...
					<ComponentShowcase title="Checkbox" description="Checkbox input">
				...
				<TabsContent value="feedback" className="space-y-6">
					...
					<ComponentShowcase title="Empty" description="Empty state component">
				...
				<TabsContent value="overlays" className="space-y-6">
					...
					>
						<p className="text-sm text-muted-foreground">
							These components require interactive state management. Refer to
							their individual component files for implementation examples.
						</p>
					</ComponentShowcase>
				</TabsContent>
				...
				<TabsContent value="display" className="space-y-6">
					...
					<ComponentShowcase title="Avatar" description="Avatar component">
						<Avatar>
