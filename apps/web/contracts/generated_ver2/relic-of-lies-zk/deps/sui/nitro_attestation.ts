 ...
 * supports PCR0-31. Required PCRs (index 0-4 & 8) are always included regardless
 * of their value. In devnet and testnet, additional custom PCRs (index 5-7, 9-31)
 * are also included if they are nonzeros. In mainnet, only required PCRs (index
 * 0-4 & 8) are included.
 */
