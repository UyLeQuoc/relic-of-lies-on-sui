...
/**
 * Error codes module for Love Letter 2019 Premium Edition (ZK Version) Contains
 * all error constants for assert! statements
 */
...
export interface InvalidProofOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidProof(options: InvalidProofOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_proof',
    });
}
...
export interface ProofTimeoutNotReachedOptions {
    package: string;
    arguments?: [
    ];
}
export function proofTimeoutNotReached(options: ProofTimeoutNotReachedOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'proof_timeout_not_reached',
    });
}
...
export interface ActionAlreadyPendingOptions {
    package: string;
    arguments?: [
    ];
}
export function actionAlreadyPending(options: ActionAlreadyPendingOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'action_already_pending',
    });
}
export interface NotPendingTargetOptions {
    package: string;
    arguments?: [
    ];
}
export function notPendingTarget(options: NotPendingTargetOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'not_pending_target',
    });
}
export interface WrongActionTypeOptions {
    package: string;
    arguments?: [
    ];
}
export function wrongActionType(options: WrongActionTypeOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'wrong_action_type',
    });
}
export interface InvalidCommitmentSizeOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidCommitmentSize(options: InvalidCommitmentSizeOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_commitment_size',
    });
}
export interface NotDealerOptions {
    package: string;
    arguments?: [
    ];
}
export function notDealer(options: NotDealerOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
...
export interface InvalidCommitmentsCountOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidCommitmentsCount(options: InvalidCommitmentsCountOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_commitments_count',
    });
}
...
export interface IsValidCommitmentSizeArguments {
    commitment: RawTransactionArgument<number[]>;
}
export interface IsValidCommitmentSizeOptions {
    package: string;
    arguments: IsValidCommitmentSizeArguments | [
        commitment: RawTransactionArgument<number[]>
    ];
}
/** Check if commitment has valid size */
export function isValidCommitmentSize(options: IsValidCommitmentSizeOptions) {
    const packageAddress = options.package;
    const argumentsTypes = [
        'vector<u8>'
    ] satisfies string[];
    const parameterNames = ["commitment"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'is_valid_commitment_size',
        arguments: normalizeMoveArguments(options.arguments, argumentsTypes, parameterNames),
    });
}