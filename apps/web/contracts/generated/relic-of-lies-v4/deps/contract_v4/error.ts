...
export interface DeckNotSubmittedOptions {
    package: string;
    arguments?: [
    ];
}
export function deckNotSubmitted(options: DeckNotSubmittedOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'deck_not_submitted',
    });
}
export interface DeckAlreadySubmittedOptions {
    package: string;
    arguments?: [
    ];
}
export function deckAlreadySubmitted(options: DeckAlreadySubmittedOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'deck_already_submitted',
    });
}
...
export interface InvalidDeckSizeOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidDeckSize(options: InvalidDeckSizeOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_deck_size',
    });
}
...
export interface HashMismatchOptions {
    package: string;
    arguments?: [
    ];
}
export function hashMismatch(options: HashMismatchOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'hash_mismatch',
    });
}
export interface InvalidHashLengthOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidHashLength(options: InvalidHashLengthOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_hash_length',
    });
}
export interface InvalidNonceLengthOptions {
    package: string;
    arguments?: [
    ];
}
export function invalidNonceLength(options: InvalidNonceLengthOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'invalid_nonce_length',
    });
}
export interface AlreadyDecryptedOptions {
    package: string;
    arguments?: [
    ];
}
export function alreadyDecrypted(options: AlreadyDecryptedOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'already_decrypted',
    });
}
export interface NotDecryptedOptions {
    package: string;
    arguments?: [
    ];
}
export function notDecrypted(options: NotDecryptedOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'error',
        function: 'not_decrypted',
    });
}
