...
export interface PendingPrinceResponseOptions {
    package: string;
    arguments?: [
    ];
}
export function pendingPrinceResponse(options: PendingPrinceResponseOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
        function: 'pending_prince_response',
    });
}
export interface HashLengthOptions {
    package: string;
    arguments?: [
    ];
}
export function hashLength(options: HashLengthOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
...
export interface NonceLengthOptions {
    package: string;
    arguments?: [
    ];
}
export function nonceLength(options: NonceLengthOptions) {
    const packageAddress = options.package;
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'constants',
